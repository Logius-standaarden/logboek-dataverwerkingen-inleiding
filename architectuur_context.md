...
| 3.1. Gemeenschappelijke begripsvorming is het startpunt      | - De data die  gebruikt worden in deze standaard, staan vermeld en uitgelegd in het [Imformatiemodel](https://github.com/Logius-standaarden/logboek-dataverwerkingen_Inleiding/). Het is van belang dat alle (overheids)organisatie die  gebruik maken van de standaard hetzelfde beeld hebben ten aanzien specifieke data  en uitwisseling daarvan om foutsituaties en verwarring te voorkomen. |
| 3.2. Metagegevens zijn begrijpelijk voor mensen              | - De  metagegevens zijn veelal ontstaan op basis van de internationale standaard OpenTelemetry.  Daarnaast worden de begrippen ook uitgelegd in het Imformatiemodel. |
| 3.3. Gegevens worden contextrijk vastgelegd                  | - Het gebruik  van metadata in deze standaard is essentieel. De context wordt uitgelegd in  het Imformatiemodel. Daarnaast zijn er verdiepingsdocumenten aanwezig  zoals het traceringsmechanisme [nog toe te voegen]  en concrete [voorbeelden](https://github.com/Logius-standaarden/logboek-dataverwerkingen_Inleiding/#voorbeelden)  van loggingssituaties. |
