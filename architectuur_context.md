...
| 3.3. Gegevens worden contextrijk vastgelegd                  | - Het gebruik  van metadata in deze standaard is essentieel. De context wordt uitgelegd in  het informatiemodel. Daarnaast zijn er verdiepingsdocumenten aanwezig  zoals het traceringsmechanisme [nog toe te voegen]  en concrete [voorbeelden](https://github.com/Logius-standaarden/logboek-dataverwerkingen_Inleiding/#voorbeelden)  van loggingssituaties. |
