...
| 3.3. Gegevens worden contextrijk vastgelegd                  | - Het gebruik  van metadata in deze standaard is essentieel. De context wordt uitgelegd in  het Imformatiemodel. Daarnaast zijn er verdiepingsdocumenten aanwezig  zoals het traceringsmechanisme [nog toe te voegen]  en concrete [voorbeelden](https://logius-standaarden.github.io/publicatie/api/Logboek_Algemeen/#voorbeelden)  van loggingssituaties. |
